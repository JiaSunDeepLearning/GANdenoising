...
def SRGAN_g(t_image, sizeof_input=None, is_train=False, reuse=False):
    ...
    with tf.variable_scope("SRGAN_g", reuse=reuse) as vs:
        ...
        print("================ srgan model starts ================")
        # print(n.name, "input: ", n.inputs.shape)
        # print(n.all_params)
        # print(n.name, "output: ", n.outputs.shape)
        ...
        # W_init - The initializer for the the weight matrix
        ...
        # n_out_channel (int or None) -- The number of output channels. - If None,
        # automatically set n_out_channel == the number of input channels / (scale x scale).
        ...
        #print(n.all_params)
        #print(n.name, "output: ", n.outputs.shape)
        #print("sizeof_input is :", sizeof_input)
        '''
        if sizeof_input is None:
            # train
            print("mode : training")
            n.outputs = tf.image.resize_images(n.outputs, size=[224, 224], method=0, align_corners=False)
        else:
            # valid
            print("mode : evaluate")
            n.outputs = tf.image.resize_images(n.outputs, size=[sizeof_input[0], sizeof_input[1]], method=0, align_corners=False)
        '''
        #print(n.name, "input: ", n.inputs.shape)
        #print(n.all_params)
        #print(n.name, "output: ", n.outputs.shape)
        print("================ srgan model ends ================")
        return n
